"""
谱图理论（Spectral Graph Theory）——介数中心性（Betweenness Centrality）

@File    :   SGT_BetweennessCentrality.py
@Time    :   2024/12/17 14:03:52
...
def compute_node_influence_betweenness(adj_matrix):
    """
...
def train_and_evaluate_with_node_influence(X_train, y_train, X_test, y_test, adj_matrix, traffic_data, scaler, epochs,
                                           ...
                                           patience_reduce_lr):
    # 计算节点影响力
    node_influence = compute_node_influence_betweenness(adj_matrix)

"""
PageRank 基于节点的链接结构和邻居的"重要性"来计算节点的权重

@File    :   PageRank.py
@Time    :   2024/12/17 13:57:55
...
def compute_node_influence_pagerank(traffic_data, window_size=12):
    """
...
def train_and_evaluate_with_node_influence(X_train, y_train, X_test, y_test, adj_matrix, traffic_data, scaler, epochs,
                                           ...
                                           patience_reduce_lr):
    # 计算节点影响力
    node_influence = compute_node_influence_pagerank(traffic_data, window_size)
